            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      Consumer<CalculatorProvider>(
                        builder: (context, equation, child) => Text(
                          equation.equation,
                          style: Theme.of(context).textTheme.bodySmall, // Thay caption bằng bodySmall
                        ),
                      ),
                    ],
                  ),
                ...
                Consumer<CalculatorProvider>(
                  builder: (context, equation, child) => Text(
                    equation.result,
                    style: Theme.of(context).textTheme.headlineLarge, // Thay headline3 bằng headlineLarge
                  ),
                ),
              ],
            ),
